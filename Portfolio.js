...
var projects = `
  {
    ...
    "image": "Eve.jpg",
    "slideshow": [["projects/Eve/EveLighter.jpg", "Here's a render that I made to look like a scene from the movie"], ["projects/Eve/EveLaugh.jpg", "A cute render I did towards the beginning of modelling EVE"], ["projects/Eve/EveCannon.mp4","Animation Showing the draw and stow of the arm cannon I made"], ["projects/Eve/EveFingers.mp4", "Status Lights + Fingers retraction and extention animation"], ["projects/Eve/EveArmAim.jpg", "Here's another render from when I was working on the arm of the render"]],
